...
class MangasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manga" do
    assert_difference("Manga.count") do
      post mangas_url, params: { manga: { external_id: @manga.external_id, image: @manga.image, last_chapter: @manga.last_chapter, last_refreshed: @manga.last_refreshed, name: @manga.name, source: @manga.source } }
    end
  ...
  test "should update manga" do
    patch manga_url(@manga), params: { manga: { external_id: @manga.external_id, image: @manga.image, last_chapter: @manga.last_chapter, last_refreshed: @manga.last_refreshed, name: @manga.name, source: @manga.source } }
